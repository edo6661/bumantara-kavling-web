    ...
    <div className="flex flex-col gap-1.5 mb-4 group w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-11 pr-4 py-2.5 text-sm rounded-xl border bg-white transition-all duration-300 outline-none text-slate-900 placeholder:text-slate-400 shadow-sm/50
            ${error
